...
class PlayingEngine(QObject):
    ...
    def __init__(
        ...
        self.player_backends: Dict[str, type[PlayerBackend]] = player_backends
        ...
        self.playing_settings: PlayingSettings = PlayingSettings(self.settings_manager)
        self.playlist_manager: PlaylistManager = PlaylistManager(self.settings_manager)
        self.history_playlist: Playlist = self.playlist_manager.new_playlist("History")

        self.playlist_manager.load_playlists()

        self.queue_manager = QueueManager(self.history_playlist)

        self.web_helper: WebHelper = WebHelper()
    ...
    def load_module(self, song: Song) -> None:
        self.module_loader.load_songs(song)
